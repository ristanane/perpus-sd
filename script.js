...
function inisialisasiSistem() {
    ...
    // 2. Setup Autocomplete standar untuk memilih buku lama
    ...
    // 3. Event tambahan khusus untuk mendeteksi ketikan manual / Buku Baru
    if (inputBuku) {
        inputBuku.addEventListener('input', function() {
            ...
            // Cek apakah judul yang diketik ada di masterBuku
